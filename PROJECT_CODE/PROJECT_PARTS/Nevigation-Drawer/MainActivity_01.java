...
public class MainActivity_01 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        displaySelectedScreen(R.id.nav_pet_diet_plan);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_main_01_drawer, menu);
        return true;
    }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_pet_diet_plan:
                fragment = new DIET_DETAILS();
                break;
            case R.id.nav_add_pet:
                fragment = new ADD_PET();
                break;
